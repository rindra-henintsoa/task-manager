...
class __TwigTemplate_c9f1af450d5697223b114a4b5877280b extends Template
{
    ...
    <div class=\"login-form\">
        ...
        // line 18
        yield "
            <h1 class=\"h3 mb-3 font-weight-normal\">Connectez-vous pour accéder à votre tableau de bord</h1>
...
<div class=\"container\">
    <div class=\"login-form\">
        <form method=\"post\">
            ...
            {% if app.user %}
                <div class=\"mb-3\">
                    Vous êtes déjà connecter en tant que {{ app.user.userIdentifier }}, <a href=\"{{ path('app_logout') }}\">Logout</a>
                </div>
            {% endif %}
...
{% endblock %}
", "security/login.html.twig", "C:\\Users\\17264\\Documents\\Formation\\task-manager\\templates\\security\\login.html.twig");
    }
}
